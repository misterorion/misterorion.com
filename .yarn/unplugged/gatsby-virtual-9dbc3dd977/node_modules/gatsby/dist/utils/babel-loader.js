...
const customBabelLoader = _babelLoader.default.custom(babel => {
  return {
    ...
    config(partialConfig, {
      ...
      const [reduxPresets, reduxPlugins, requiredPresets, requiredPlugins, fallbackPresets] = (0, _babelLoaderHelpers.prepareOptions)(babel, customOptions); // If there is no filesystem babel config present, add our fallback
      // presets/plugins.
