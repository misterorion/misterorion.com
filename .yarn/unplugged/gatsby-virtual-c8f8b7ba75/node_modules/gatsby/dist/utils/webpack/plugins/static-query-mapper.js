...
const removeExportQueryParam = path => {
  ...
  const [filePath, queryParams] = path === null || path === void 0 ? void 0 : path.split(`?`);
  ...
  apply(compiler) {
    ...
    compiler.hooks.finishMake.tapPromise({
      ...
      function traverseModule(module, config, visitedModules = new Set()) {
        ...
        if (component) {
          config.onComponent(component); // don't return here yet, as component might be imported by another one, and we want to traverse up until we reach async-requires
        }
