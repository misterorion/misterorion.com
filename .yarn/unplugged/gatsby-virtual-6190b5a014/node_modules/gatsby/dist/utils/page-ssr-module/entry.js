...
async function renderPageData({
  ...
  try {
    ...
    const sliceOverrides = data.page.slices; // @ts-ignore GATSBY_SLICES is being "inlined" by bundler
    ...
    const slicesUsedByTemplatesFromBundler = // @ts-ignore GATSBY_SLICES_BY_TEMPLATE is being "inlined" by bundler
