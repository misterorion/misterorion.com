...
export default () => {
  return (
    <div className="flex w-auto mb-8 p-6 items-center border border-teal-400 rounded shadow">
      <div className="block w-full flex-auto sm:w-1/3 lg:w-1/4 mr-6" >
        <img src={Me} alt="Orion Anderson" className="w-40"/>
      </div>
        <div className="block w-full sm:w-2/3 lg:w-3/4 text-lg sm:text-lg lg:text-xl xl:text-2xl leading-snug">
